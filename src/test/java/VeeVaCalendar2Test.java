...
class VeeVaCalendar2Test {

    @Test
    void dayOfYearInvalidDayTest() {
        int actualDay = VeeVaCalendar2.dayOfYear(2015, 2, 29);
        Assertions.assertEquals(-1, actualDay);
    }

    @Test
    void dayOfYearInvalidDay1Test() {
        int actualDay = VeeVaCalendar2.dayOfYear(2016, 2, 30);
        Assertions.assertEquals(-1, actualDay);
    }

    @Test
    void dayOfYearInvalidDay2Test() {
        int actualDay = VeeVaCalendar2.dayOfYear(2016, 4, 31);
        Assertions.assertEquals(-1, actualDay);
    }

    @Test
    void dayOfYearInvalidMonthTest() {
        int actualDay = VeeVaCalendar2.dayOfYear(2016, 13, 1);
        Assertions.assertEquals(-1, actualDay);
    }
    ...
    void dayOfYearInvalidLeapYearTest() {
        int actualDay = VeeVaCalendar2.dayOfYear(1900, 2, 29);
        Assertions.assertEquals(-1, actualDay);
    }

    @Test
    void dayOfYearEffectiveTest() {
        int actualDay = VeeVaCalendar2.dayOfYear(2016, 2, 29);
    ...
    @Test
    void dayOfYear3Test() {
        int actualDay = VeeVaCalendar2.dayOfYear(2016, 1, 3);
    ...
    void dayOfYear32Test() {
        int actualDay = VeeVaCalendar2.dayOfYear(2016, 2, 1);
        Assertions.assertEquals(32, actualDay);
    }

    @Test
    void dayOfYear365Test() {
        int actualDay = VeeVaCalendar2.dayOfYear(2021, 12, 31);
        Assertions.assertEquals(365, actualDay);
    }

    @Test
    void dayOfYear366Test() {
        int actualDay = VeeVaCalendar2.dayOfYear(2020, 12, 31);
